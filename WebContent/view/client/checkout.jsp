			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="single-sidebar">
						...
						<ul>
							<li><a href="single-product.html">Iphone 7</a></li>
							<li><a href="single-product.html">Iphone 7 Plus</a></li>
							<li><a href="single-product.html">Iphone 8</a></li>
							<li><a href="single-product.html">Samsung Note 8</a></li>
							<li><a href="single-product.html">Oppo F1</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="woocommerce">
							...
							<form id="coupon-collapse-wrap" method="post"
								...
								<p class="form-row form-row-last">
									<c:choose>
										<c:when test="${msg eq 'You can only use 1 coupon' }">
							...
							<form action="/Final/member/add-order" class="checkout"
										...
										<div class="woocommerce-billing-fields">
											...
											<p id="billing_phone_field"
												...
												<label class="" for="billing_phone">Phone <abbr
													...
													id="billing_phone" name="phone" class="input-text ">
											</p>
											<div class="clear"></div>
										</div>
									</div>
									...
									<table class="shop_table">
										...
										<tbody>
											<tr class="cart_item">
												...
												<td class="product-total"><span class="amount">£${sessionScope.total }</span>
												</td>
											</tr>
										</tbody>
										<tfoot>
											...
											<tr class="cart-subtotal">
												<th>Cart Subtotal</th>
												<td><span class="amount">£${sessionScope.total}</span></td>
											</tr>
											<c:set var="discount" value="${sessionScope.coupon.percent}" />
											<tr class="shipping">
												<th>Discount</th>
												<td>${discount}%</td>
											</tr>
											...
											<tr class="order-total">
												...
												<c:choose>
													<c:when test="${coupon != null }">
														<td><strong><span class="amount">£${sessionScope.total * (100 - coupon.percent)/100 }</span></strong>
													</c:when>
													<c:otherwise>
														<td><strong><span class="amount">£${sessionScope.total}</span></strong>
													</c:otherwise>
												</c:choose>

			...
			<div class="row">
				<div class="col-md-4">
					...
					<div class="single-sidebar">
						...
						<ul>
							<li><a href="">Sony Smart TV - 2021</a></li>
							<li><a href="">Sony Smart TV - 2021</a></li>
							<li><a href="">Sony Smart TV - 2021</a></li>
							<li><a href="">Sony Smart TV - 2021</a></li>
							<li><a href="">Sony Smart TV - 2021</a></li>
				...
				<div class="col-md-8">
					<div class="product-content-right">
						<div class="product-breadcroumb">
							<a href="/Final/shop">Shop</a><a href="">${productDetail.name}</a>
						</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="product-images">
									<div class="product-main-img">
										<img src="/Final/product/download?url=${productDetail.image }"
											alt="">
									</div>

									<div class="product-gallery">
										<img src="/Final/product/download?url=product-thumb-1.jpg"
											alt=""> <img
											src="/Final/product/download?url=product-thumb-2.jpg" alt="">
										<img src="/Final/product/download?url=product-thumb-3.jpg"
											alt="">
									</div>
								</div>
							</div>
							...
							<div class="col-sm-6">
								<div class="product-inner">
									...
									<form action="/Final/add-to-cart?productId=${productDetail.id }" class="cart" method = "post">
										<div class="quantity">
						...
						<div class="related-products-wrapper">
                            <h2 class="related-products-title">Related Product</h2>
                            <div class="related-products-carousel">
                                <div class="single-product">
                                    <div class="product-f-image">
                                        <img src="/Final/product/download?url=product-1.jpg" alt="">
                                    ...
                                    <h2><a href="">Sony Smart TV - 2021</a></h2>

			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="p-3 mb-2 bg-light text-dark mt-3 border-bottom">Sửa
						sản phẩm</div>
					<form action="/Final/admin/product/edit" method="post">
						<div class="form-floating mt-3 mb-3">
							<input type="text" class="form-control" id="floatingInput"
								name="id" readonly="readonly" value = "${editProduct.id }"> <label
								for="floatingInput">ID</label>
						</div>
						<div class="form-floating mt-3 mb-3">
							<input type="text" class="form-control" id="floatingInput"
								name="productName" value = "${editProduct.name }"> <label
								for="floatingInput">Name</label>
						</div>
						<div class="form-floating mt-3 mb-3">
							<input type="number" class="form-control" id="floatingInput"
								name="quantity" value = "${editProduct.quantity }"> <label
								for="floatingInput">Quantity</label>
						</div>
						<div class="form-floating mt-3 mb-3">
							<input type="number" class="form-control" id="floatingInput"
								name="price" value = "${editProduct.price }"> <label
